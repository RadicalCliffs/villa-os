      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            <form className="flex gap-2 w-full md:w-auto" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                className="bg-emerald-900/50 border border-emerald-700/50 rounded-lg px-4 py-2 text-sm text-white placeholder-emerald-400/50 focus:outline-none focus:ring-2 focus:ring-emerald-500 w-full md:w-64 focus-glow"
              />
              <button
                type="submit"
        ...
        <div className="border-t border-emerald-800/50 mt-8 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            {/* Social links */}
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-emerald-100/40 hover:text-white social-icon-hover" aria-label="Facebook">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-emerald-100/40 hover:text-white social-icon-hover" aria-label="Instagram">
            ...
            <a href="https://line.me" target="_blank" rel="noopener noreferrer" className="text-emerald-100/40 hover:text-white social-icon-hover" aria-label="Line">
